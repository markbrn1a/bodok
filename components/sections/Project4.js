              ...
              <div className="project-item-four">
                ...
                <div className="project-content-four">
                  <div className="content-left">
                    <h2 className="title">
                      <Link href="/project-details">Replacement of Roof</Link>
                    </h2>
                    <ul className="list-wrap">
                      <li>
                        <Link href="/project-details">Roof</Link>
                      </li>
                      <li>
                        <Link href="/project-details">Ideas</Link>
                      </li>
                    </ul>
                  </div>
            ...
            <div className="col-lg-4">
              <div className="project-item-four">
                ...
                <div className="project-content-four">
                  <div className="content-left">
                    <h2 className="title">
                      <Link href="/project-details">Fixing of Roof Damage</Link>
                    </h2>
                    <ul className="list-wrap">
                      <li>
                        <Link href="/project-details">Roof</Link>
            ...
            <div className="col-lg-4">
              <div className="project-item-four">
                ...
                <div className="project-content-four">
                  <div className="content-left">
                    <h2 className="title">
                      <Link href="/project-details">Modern Roofing Style</Link>
                    </h2>
                    <ul className="list-wrap">
                      <li>
                        <Link href="/project-details">Roof</Link>
