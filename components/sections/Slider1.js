    ...
    <>
      <section className="slider-area">
        <div
          ...
          data-background="/assets/img/slider/slider_shape.png"
        />
        <div className="slider-img-wrap">
          <Slider
            ...
            infinite={true}
            speed={500}
            className="sliderNav-active"
          >
            <div
              className="slider-img-item"
              data-background="/assets/img/slider/slider_img01.jpg"
            />
            <div
              className="slider-img-item"
              data-background="/assets/img/slider/slider_img02.jpg"
            />
          </Slider>
        </div>
